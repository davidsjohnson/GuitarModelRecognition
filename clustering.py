...
dataset = np.load("data/bextract_single_test.npz")
data = scale(dataset['features'])
...
reduced_data_acoustic = reduced_data[:idx]
reduced_data_electric = reduced_data[idx:]
...
plt.plot(reduced_data_acoustic[:, 0], reduced_data_acoustic[:, 1], 'k.', markersize=3)
plt.plot(reduced_data_electric[:, 0], reduced_data_electric[:, 1], '+', markersize=3)
